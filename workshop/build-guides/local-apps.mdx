...
<AccordionGroup>
  ...
  <Accordion title="Use local models for on-device inference">
    Workshop Desktop lets you power the agent with a local model running on your machine without hosted-model inference charges. Other features and diagnostics can still send data externally; see [local model setup and privacy limits](/workshop/workshop-desktop/local-models). Switch to a hosted model when you need its capabilities.
  </Accordion>
...
- [Local models](/workshop/workshop-desktop/local-models) — Set up on-device inference and understand its limits
