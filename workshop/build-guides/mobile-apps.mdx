...
<AccordionGroup>
  ...
  <Accordion title="Use local models for AI-powered mobile apps">
    If your app includes AI features, you can develop and test inference against a local model running on your machine without hosted-model inference charges. This does not prevent other app features or development tools from using network services. Switch to a managed AI connector when you're ready to ship.
  </Accordion>
</AccordionGroup>
