...
With **Privacy Mode** enabled, your conversations are also never stored externally. When disabled, Workshop may collect usage and telemetry data to improve the product.
