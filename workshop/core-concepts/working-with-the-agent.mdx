...
To keep credit use down without picking a model yourself, choose **ARC** at the top of the selector — Workshop routes your work to a suitable model, using a cheaper one for routine tasks and a stronger one for harder ones. See [ARC in Settings](/workshop/core-concepts/settings#arc).
