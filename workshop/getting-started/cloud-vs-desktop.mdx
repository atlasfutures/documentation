...
| **Offline inference** | No | Yes (with downloaded local models; other features may require a connection) |
...
- **Local AI models** — Run inference on your own hardware without hosted-model inference charges. Other features and diagnostics can still send data externally; see [local model privacy limits](/workshop/workshop-desktop/local-models).
