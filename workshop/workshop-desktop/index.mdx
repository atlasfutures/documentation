...
<CardGroup cols={2}>
  ...
  <Card title="Local AI models" icon="microchip">
    Run open-weight models on your own hardware to power the Workshop agent without hosted-model inference charges. See local model setup and privacy limits below.
  </Card>
...
Desktop stores your project files and runs development tools on your computer. Hosted AI requests send the context needed for those requests, which can include code. Publishing, syncing, and sharing can upload files or conversation content.

Local models keep inference on-device, but do not disable network tools, publishing, syncing, sharing, or diagnostics. [Privacy Mode](/workshop/core-concepts/settings#privacy-mode) limits conversation-content collection for telemetry; it is not a guarantee that no data leaves your computer. See [what information Workshop stores](/workshop/pricing/billing-faqs#what-information-do-you-store).
